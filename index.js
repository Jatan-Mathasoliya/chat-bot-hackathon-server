...
const uri = "mongodb+srv://CodingGita:Xn3NZl5dZH2k85Xl@codinggita-student-port.w348a.mongodb.net/"; // MongoDB URI
const client = new MongoClient(uri);
const dbName = "just_home"; // Database name

const GEMINI_API_KEY = "AIzaSyAF62BrQcOOaCwVwdN8mgz7awzEe15T71U";
